namespace Forum.App.Menus
{
    ...
    public class SignUpMenu : Menu
    {
        ...
        private ICommandFactory command;

        public SignUpMenu(ILabelFactory labelFactory, IForumReader reader, ICommandFactory command)
        {
        ...
        public override IMenu ExecuteCommand()
        {
            ...
            try
            {
                ...
                ICommand command = this.command.CreateCommand(commandName);
